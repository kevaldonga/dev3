...
npx sequelize-cli model:generate --name profiles --force --attributes userId:integer,profileImg:string,isActive: boolean,name:string,bio:string,followings:integer,followers:integer,uuid:UUID
