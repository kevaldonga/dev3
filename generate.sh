npx sequelize-cli model:generate --name users --force --attributes username:string,password:string,isActive:boolean,uuid:UUID,token:UUID 
...
npx sequelize-cli model:generate --name profiles --force --attributes userId:integer,profileImg:string,name:string,bio:string,uuid:UUID
